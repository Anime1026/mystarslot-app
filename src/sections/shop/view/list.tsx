...
export default function UserListView() {
    ...
    const shoper = async () => {
        const data = await getList({ type: 'shop' });
    ...
    const handleEditRow = useCallback(
        (id: string) => {
            router.push(paths.shop.edit(id));
        },
        [router]
    );
    ...
    return (
        <>
            <Container maxWidth={settings.themeStretch ? false : 'lg'}>
                <CustomBreadcrumbs
                    ...
                    links={[
                        ...
                        { name: 'Shops', href: paths.shop.list },
                        { name: 'List' }
                    ]}
                    action={
                        <Button
                            component={RouterLink}
                            href={paths.shop.create}
                            variant="contained"
            ...
            <ConfirmDialog
                ...
                content={
                    <>
                        Are you sure want to desable <strong> {table.selected.length} </strong> items?
                    </>
                }
                action={
                    <Button

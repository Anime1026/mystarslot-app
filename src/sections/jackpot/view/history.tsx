...
// api
import { getJackpotHistory } from 'src/api';
// components
...
import TableFiltersResult from './table/table-filters-result';
...
export default function InvoiceListView() {
    ...
    const transactions = async () => {
        const data = await getJackpotHistory();

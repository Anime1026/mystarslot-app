  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        action={
          <Button variant="contained" color="info" onClick={() => { onEnableRow(); enableUser.onFalse(); }}>
            Enable
          </Button>
        }
      />
      <ConfirmDialog
        ...
        action={
          <Button variant="contained" color="warning" onClick={() => { onDisableRow(); disableUser.onFalse() }}>
            Disable
          </Button>
        }
      />

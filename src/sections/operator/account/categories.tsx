...
export default function AccountNotifications() {
  ...
  const [selectedValue, setSelectedValue] = useState(['sports', 'sportsLive', 'casino', 'liveCasino', 'virtual', 'racing', 'esports', 'tournaments']);
  ...
  const getData = async () => {
    ...
    if (result.status) {
      ...
      states.shift();
      const array = ['sports', 'sportsLive', 'casino', 'liveCasino', 'virtual', 'racing', 'esports', 'tournaments'];
      const sValue = [];

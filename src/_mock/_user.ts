...
export const _userFeeds = [...Array(3)].map((_, index) => ({
  ...
  personLikes: [...Array(20)].map((__, personIndex) => ({
    ...
    avatar: _mock.image.avatar(personIndex + 2),
  })),
  comments: (index === 2 && []) || [
    {
      id: _mock.id(7),
      author: {
        id: _mock.id(8),
        avatar: _mock.image.avatar(index + 5),
    ...
    },
    {
      ...
      author: {
        id: _mock.id(10),
        avatar: _mock.image.avatar(index + 6),
...
export const _userList = [...Array(20)].map((_, index) => ({
  ...
  avatar: _mock.image.avatar(index),
  phoneNumber: _mock.phoneNumber(index),
  lastLogin: '2023-11-08 01:44:21.503z',
  ipAddress: '10.0.0.1',
  status:
